        ...
        <div className="rounded-xl border border-border bg-card p-5 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              <span className="text-foreground">Resume V3</span> performs{" "}
              <span className="text-success font-medium">42% better</span> for backend roles than V2. Consider
              consolidating older versions to focus on stronger performers.
            </p>
          </div>
                ...
                <tr key={r.id} className="border-b border-border last:border-0 hover:bg-secondary/40 transition-colors">
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      {r.primary && <Badge variant="outline" className="ml-1">Primary</Badge>}
                    </div>
                  </td>
